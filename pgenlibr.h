#ifndef __QPGEN_PGENLIBR_H
#define __QPGEN_PGENLIBR_H
/*
 *
...
public:
  ...
  void ReadIntHardcalls(std::vector<int>& buf, int const& thr, int variant_idx, int allele_idx);
